...
def make_tome_class(transformer_class):
    class ToMeVisionTransformer(transformer_class):
        ...
        def forward_features(self, x: torch.Tensor) -> torch.Tensor:
            ...
            patches = x[:, 1:, :]     # [B, H*W, C] patch tokens (already contains position information)
            ...
            if hasattr(self.patch_embed, 'img_size') and hasattr(self.patch_embed, 'patch_size'):
                ...
                # reorder the patch tokens to 2D format and apply Gilbert reordering
                ...
                # recombine class token and reordered patches
